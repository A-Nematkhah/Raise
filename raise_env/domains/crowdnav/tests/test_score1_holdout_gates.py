...
from domains.crowdnav.dataset import TrajectoryRecord, split_stage1_dataset
from raise_core.scoring import make_score1_fn, score1_for_dataset
...
def test_scenario_scores_and_failure_hints():
    ...
    from raise_core.scoring import format_score1_failure_hints
...
def test_mutation_weakness_includes_parent_diagnostics(monkeypatch):
    ...
    monkeypatch.setattr(
        "raise_core.explore.format_d2_mutation", fake_mutation
    )
    code = (
