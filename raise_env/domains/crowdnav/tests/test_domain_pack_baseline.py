...
from domains.crowdnav import prompts as pack_prompts
import crowd_nav.reward_search.prompts as legacy_prompts
...
def test_make_score_fn_for_domain_smoke_matches_direct():
    from raise_core.domains import make_score_fn_for_domain
    from raise_core.scoring import make_smoke_score_fn
    from domains.crowdnav.state import RewardFunction, RewardState
...
def test_make_stage_trainers_use_adapter_bridge():
    ...
    from domains.crowdnav.adapter import (
...
def test_stub_bridge_matches_direct_stub_metrics():
    ...
    from domains.crowdnav.adapter import make_stage2_trainer
    from raise_core.explore import RewardCandidate
    from raise_core.refine import Stage2Config, StubPolicyTrainer
...
def test_crowdnav_adapter_rejects_bad_stage():
    from domains.crowdnav.adapter import CrowdNavAdapter
    from raise_core.explore import RewardCandidate
