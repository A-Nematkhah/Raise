...
from raise_core.sandbox import (
    RewardSandboxError,
    RewardValidator,
    SandboxConfig,
)
...
def test_prompt_memory_example_validates_in_sandbox():
    ...
    from domains.crowdnav.prompts import D5_SEED_FUNCTION, PROMPT_MEMORY_EXAMPLE
...
def test_memory_cleared_on_reset():
    from domains.crowdnav.prompts import PROMPT_MEMORY_EXAMPLE
