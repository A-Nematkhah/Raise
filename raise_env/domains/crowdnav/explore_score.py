...
Implementation stays in ``raise_core.{scoring,dataset,rules}``
...
def make_score_fn(
    *,
    ...
    from domains.crowdnav.dataset import load_stage1_dataset
    from raise_core.scoring import make_score1_fn
