...
from raise_core.active_learning import acquire as acquire_mod
from raise_core.active_learning import queue as queue_mod
...
def run_active_learning_step(
    *,
    ...
    score_fn = None
    if batch:
        from raise_core.domains import load_domain
