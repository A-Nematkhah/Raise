...
from raise_core.parallelism import (
...
from raise_core.refine import ProxyMetrics, evaluate_proxy_policy
...
class Stage3Runner:
    ...
    def _resolve_ckpt_dir(self) -> str:
        from raise_core.stage3_checkpoint import stage3_dir_from_train_root
    ...
    def _append_history_record(self, rec: Stage3RoundRecord) -> None:
        from raise_core.stage3_checkpoint import history_record_to_dict
    ...
    def _record_trained_snapshot(
        ...
        *,
        ...
        from raise_core.proxy_consistency import genome_key
    ...
    def _train_refine_one(
        ...
        *,
        ...
        from raise_core.checkpointing import CheckpointKey, CostEvent
